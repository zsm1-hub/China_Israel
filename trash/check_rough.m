...
for ii=1:length(nparticles)
    ...
    [SpecFlux,Vt,ebs,kf,lf]=Fk_fitting_SF3(SF3,dist_axis,1.5e3,300e3,'log','RLS',lambda);
    dstr=1;
    figure(1)
    subplot(2,2,ii)
...
%%
clear;clf
load wave_pars_P625T89.5daysSF123_rough.mat
SF3_625=SF3lll+SF3ltt;
load wave_pars_P289T89.5daysSF123_rough.mat
SF3_289=SF3lll+SF3ltt;
load wave_pars_P2500T89.5daysSF123_rough.mat
SF3_2500=SF3lll+SF3ltt;
isequal(SF3_289,SF3_2500)

plot(SF3_289);hold on
plot(SF3_625)
plot(SF3_2500)

load wave_pars_P289T89.5daysCG_Lag_spectukey_rough.mat
ii=1
semilogx(filtscale./1e3,Th','LineWidth',1.5,'Color',colors{ii},'LineStyle','--');hold on
load wave_pars_P625T89.5daysCG_Lag_spectukey_rough.mat
ii=2
semilogx(filtscale./1e3,Th','LineWidth',1.5,'Color',colors{ii},'LineStyle','--');hold on

load wave_pars_P2500T89.5daysCG_Lag_spectukey_rough.mat
ii=3
semilogx(filtscale./1e3,Th','LineWidth',1.5,'Color',colors{ii},'LineStyle','--');hold on
