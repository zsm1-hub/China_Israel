...
set(gca,'xscale','log')
hold on
b1=semilogx(filtscale./1e3.*rs2,Thm_Eulerian,'LineWidth',1.5,'Color',colors{1});
hold on
% r_cg_eul = findXatYZero(filtscale./1e3, Thm_Eulerian);

b2=semilogx(1./kf_E(2:end)./1e3.*rescale,SpecFlux_E(2:end), ...
    'LineWidth',1.5, ...
'Color','k');
% r_RLS_eul = findXatYZero(1./kf_E(dstr:end)./1e3.*2.*pi,SpecFlux_E(dstr:end));

B1=semilogx(filtscale./1e3.*rs2,Th_Lag289,'LineWidth',1.5,'Color',colors{4}, ...
    'LineStyle','--')
% hold on
...
B1=semilogx(filtscale./1e3.*rs2,Th_Lag625,'LineWidth',1.5,'Color',colors{5}, ...
    'LineStyle','--')
% hold on
...
B1=semilogx(filtscale./1e3.*rs2,Th_Lag1089,'LineWidth',1.5,'Color',colors{6}, ...
    'LineStyle','--')
% hold on
...
saveas(gcf,['test3_Bayesian_Eul_Lag_CG', ...
