...
[SpecFlux_E,Vt_E,ebs_E,kf_E,lf_E,kfo]=Fk_fitting_SF3(SF3(1:dot)',r(1:dot),0.04,3.32, ...
    'log','RLS',lambda,kf1);
[SpecFlux_E2,Vt_E2,ebs_E2,kf_E2,lf_E2,kfo]=Fk_fitting_SF3(SF3(1:dot)',r(1:dot),0.04,3.32, ...
    'log','RLS',lambda,kf1./2./pi);
...
a7=semilogx(lf_E2,Vt_E2./lf_E2','Color','k','LineWidth',1.5)
hold on
...
a4=semilogx(lf_L,Vt_L62500./lf_L','Linestyle', ...
    '-','Color',[0.5, 0.6, 0.4],'LineWidth',1.5)
