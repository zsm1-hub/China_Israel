...
close all
%change by zsm
% D:\LIN2023\model\RoyBarkan\R4.x265.237.0001
%%
...
traj = load('../code_to_process_data/traj_mat_LASER_15min_04_May_2021.mat');
load('../code_to_process_data/traj_depth_LASER.mat');
Htraj=-501.*ones(9643,956);
...
save ./structure_pairs_LASER_deep_500m_box_constrained.mat pairs_time -v7.3
