...
% kf1=kf1(1:1:end);
[SpecFlux_E,Vt_E,ebs_E,kf_E,lf_E]=Fk_fitting_SF3_Lcurve(SF3(1:dot)',r(1:dot),0.009,6.32, ...
    'log','RLS',lambda,kf1,0);
[SpecFlux_E2,Vt_E2,ebs_E2,kf_E2,lf_E2]=Fk_fitting_SF3(SF3(1:dot)',r(1:dot),0.009,6.32, ...
    'fuc','RLS',lambda,kf1./2./pi);

[lf_E,Y,Y_std,kf_E,dkf,Vt_E,ebs_E,SpecFlux_E,Fk_uncertainty,...
    eps_error,...
    optimal_fac,optimal_po]=Fk_fitting_SF3_Bayesian_hit2d_RLS_Lcurve_uncertainty('Eul',...
    0.009,6.32,15)
